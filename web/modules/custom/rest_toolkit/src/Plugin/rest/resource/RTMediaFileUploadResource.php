 ...
 *
 * @RestResource(
 *   id = "rt_media_file:upload",
 *   label = @Translation("Rest Toolkit Upload File as Media entity"),
 *   serialization_class = "Drupal\file\Entity\File",
 *   uri_paths = {
 *     "https://www.drupal.org/link-relations/create" = "/rest_toolkit/upload/{entity_type_id}/{bundle}/{field_name}"
 *   }
 * )
 */
class RTMediaFileUploadResource extends ResourceBase {
